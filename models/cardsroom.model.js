...
const CardsRoomSchema = new mongoose.Schema(
  {
    name: {
      type: String,
      required: true,
    ...
    turn: { type: mongoose.Schema.Types.ObjectId, ref: "User", default: null }, // Name of the player whose turn it is
...
CardsRoomSchema.index({ "players.player": 1, gameStatus: 1, createdAt: -1 });

// Error handling for duplicate names
CardsRoomSchema.post("save", function (error, doc, next) {
...
const cardsRoomModel =
  mongoose?.models?.CardsRoom || mongoose.model("CardsRoom", CardsRoomSchema);

export default cardsRoomModel;
