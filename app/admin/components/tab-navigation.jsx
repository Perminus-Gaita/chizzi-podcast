...
import { MessageCircle, Users, Webhook } from 'lucide-react'; // Changed from BrandTelegram to MessageCircle
...
const TabNavigation = ({ formOptions }) => {
  ...
  const selectedChildTab = searchParams.get('section') || 'SendMessage';
