...
const KadiTable = ({ roomSlug }) => {
  ...
  const {
    ...
    changedSuit,
  } = useKadiAISocket(roomSlug, userProfile, gameRef);
  ...
  useEffect(() => {
    if (roomDataCopy && roomDataCopy[0]?.gameStatus === "gameover") {
      const handleClick = () => {
        handleOpenGameOverModal();
      };
                                ...
                                (roomDataCopy[0]?.isQuestion ||
                                  ...
                                  <div
                                    style={{
                                      ...
                                      top:
                                        gameRef?.current?.centerY +
                                        positions?.table?.height / 2, // Position it below center but above bottom player
                                  ...
                                  >
                                    <PickPointer
                                      positions={positions}
                                      isSmallScreen={isSmallScreen}
                                      isPenalty={roomDataCopy[0]?.isPenalty}
                                      isLastPlayer={
                                        roomDataCopy[0]?.lastGamePlay
                                          ?.player === userProfile.uuid
                                      }
                                      isQuestion={roomDataCopy[0]?.isQuestion}
                                    />
                                  </div>
                                )} */}
...
onClick={() => {
  setReaction({
    player: "676112252e2cd5a9df380aae",
...
onClick={() => {
  setReaction({
    player: "676112252e2cd5a9df380aab",
    src: "/cards/emojis/emoji1.webp",
    text: "Not so fast!",
  });
}}
...
Left
          ...
          {/* 676112252e2cd5a9df380aaf  - RIGFH
676112252e2cd5a9df380aae - top
676112252e2cd5a9df380aab - left
*/}
