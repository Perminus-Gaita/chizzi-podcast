...
const TelegramConnect = () => {
  ...
  // Use the bot username instead of just the ID
  ...
  const handleTelegramLogin = async () => {
    ...
    try {
      window.Telegram.Login.auth(
        {
          bot_id: botId, // Use the username instead of numeric ID
          request_access: "write", // This is crucial - "write" permission allows the bot to message first
          lang: 'en'
        },
        async (data) => {
          if (!data) {
