...
export default function AppLayout({ children }) {
  ...
  const handleOpenWorkspace = () => setIsWorkspace(true);
  const handleCloseWorkspace = () => setIsWorkspace(false);
        ...
        <div className="flex relative">
          ...
          >
            <LeftSideBar
              ...
              handleOpenWorkspace={handleOpenWorkspace} // Changed to match expected prop name
            />
          </aside>
