...
const BlogLayout2 = ({ blog }) => {
  return (
    <div className="group grid grid-cols-12 gap-4 items-center text-dark dark:text-light h-full min-h-[80px]">
      <Link
        href={blog.url}
      ...
      <div className="col-span-12 lg:col-span-8 w-full">
        ...
        <span className="inline-block w-full capitalize text-gray dark:text-light/50 font-light text-xs sm:text-md">
